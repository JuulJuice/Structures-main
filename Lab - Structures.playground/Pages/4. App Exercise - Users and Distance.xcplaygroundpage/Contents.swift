 ...
 */
var julian = user(name: "Julian", age: 17, height: 5.4, weight: 160.0, activityLevel: 4)
...
struct Distance{
    ...
    init(meters:Double){
        self.meters = meters
        self.feet = meters*28084
    }
    
    init(feet:Double){
        self.feet = feet
        self.meters = feet/28084
    }
}
 ...
 */
var mile = Distance(meters: 1600, feet: <#T##Double#>)
